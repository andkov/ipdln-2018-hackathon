---
title: "Demo of Graphing Technqiue"
...
output: 
  html_document: 
    ...
    theme: spacelab
---
This report provides annotation layer to the computational script
`./reports/technique-demonstration/technique-demonstration.R`
For the full technical report of this script, see its stitched output
`./reports/technique-demonstration/stitched_output/technique-demonstration.html`
...
read_chunk("./reports/technique-demonstration/technique-demonstration.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
# Re-Scale variables
```{r rescale-variables, echo=echo_chunks, results='show', message=message_chunks}
```

# Data for model
```{r isolate-for-modeling, echo=echo_chunks, results='show', message=message_chunks}
```

# Model Specification
```{r model-specification, echo=echo_chunks, results='show', message=message_chunks}
```

# Model Estimation 
```{r model-estimation, echo=echo_chunks, results='show', message=message_chunks}
```

# Model Prediction 
```{r model-prediction, echo=echo_chunks, results='show', message=message_chunks}
```
