...
read_chunk("./reports/eda-1/eda-1.R") #This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r select-focus, echo=TRUE, results='show', message=message_chunks}
```
